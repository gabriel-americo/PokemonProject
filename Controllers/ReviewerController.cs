...
namespace PokemonReviewApp.Controllers
{
    ...
    public class ReviewerController : Controller
    {
        ...
        public IActionResult GetReviewer(int reviewerId)
        {
            ...
            var reviewer = _mapper.Map<ReviewerDTO>(_reviewerRepository.GetReviwer(reviewerId));
        ...
        public IActionResult GetReviewsByAReviewer(int reviewerId)
        {
            ...
            var reviews = _mapper.Map<List<ReviewDTO>>(_reviewerRepository.GetReviwesByReviers(reviewerId));
        ...
        public IActionResult CreateReviewer([FromBody] ReviewerDTO reviewerCreate)
        {
            ...
            var reviewer = _reviewerRepository.GetReviwers()
        ...
        public IActionResult DeleteCategory(int reviewerId)
        {
            ...
            var categoryToDelete = _reviewerRepository.GetReviwer(reviewerId);

            if (!ModelState.IsValid)
                return BadRequest(ModelState);

            if (!_reviewerRepository.DeleteReviwer(categoryToDelete))
